...
class ModelCrearTercero extends Model
{
    use HasFactory;
    ...
    protected static function paramentros_ws_siesa($plano_1)
    {
        ...
        <Linea>" . $plano_1 . "</Linea>
        <Linea>000000399990001002</Linea>
        </Datos>
        </Importar>";
    ...
    public static function ejecutarConsultaWs($plano1)
    {
        $parametros_siesa = self::paramentros_ws_siesa($plano1);

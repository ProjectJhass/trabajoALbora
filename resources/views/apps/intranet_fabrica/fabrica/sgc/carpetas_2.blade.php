                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="callout callout-danger">
                            <div class="row mt-3">
                                <div class="col-md-8">
                                    <form id="formulario-nuevo-doc-sgc-sub" method="post" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="col-md-4">
                                    <button type="button" class="btn btn-danger"
                                        onclick="CargarDocuemtosSGC('{{ $carpeta }}','{{ $subcarpeta }}', '{{ route('cargar.sgc') }}','formulario-nuevo-doc-sgc-sub')">Cargar
                                        documento</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="card card-outline card-danger">
                        <div class="card-body">
                            <table class="table table-sm table-bordered table-striped" id="table-informacion-general-docs-n2">
                                <thead>

...
<head>
    ...
    <!--<![endif]--><!--[if gte mso 15]><xml><o:OfficeDocumentSettings><o:AllowPNG/><o:PixelsPerInch>96</o:PixelsPerInch></o:OfficeDocumentSettings></xml><![endif]--><!--[if gte mso 9]><xml><o:OfficeDocumentSettings><o:AllowPNG/><o:PixelsPerInch>96</o:PixelsPerInch></o:OfficeDocumentSettings></xml><![endif]-->
</head>
...
<body>
    ...
    <table border="0" align="center" width="100%" cellpadding="0" cellspacing="0" class="main-template"
        ...
        <tbody>
                                                                        ...
                                                                        <table cellspacing="0" cellpadding="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <div
                                                                                            style="border-radius:5px; width:590;;max-width:773px !important;border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;border-collapse: separate;border-radius: 0px;">
                                                                                            <div><img
                                                                                                    ng-if="col.img.source"
                                                                                                    border="0"
                                                                                                    hspace="0"
                                                                                                    vspace="0"
                                                                                                    width="590"
                                                                                                    ...
                                                                                                    src="https://img.mailinblue.com/2547420/images/rnb/original/5fb70984c0559c6eb5592fc1.jpg">
                                                                                            </div>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top"><a href="#"
                                                        ...
                                                        <table border="0" width="100%" cellpadding="0"
                                                            ...
                                                            style="height: 0px; background-color: rgb(255, 255, 255); border-radius: 0px; border-collapse: separate; padding-top: 10px; padding-left: 20px; padding-right: 20px;">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="rnb-container-padding"
            ...
            <td valign="top" width="590" style="width:590px;">
            <![endif]-->
                                        <table class="rnb-del-min-width" width="100%" cellpadding="0"
                                            border="0" cellspacing="0" style="min-width:100%;" name="Layout_9">
                                            <tbody>
                                                <tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div>
                                                                                                                <strong>N&uacute;mero
                                                                                                                    de
                                                                                                                    Registro:</strong>&nbsp;{{ $data['numero_registro'] }}<br>
                                                                                                                <strong>Fecha
                                                                                                                    de
                                                                                                                    Registro:</strong>&nbsp;{{ $data['fecha_registro'] }}<br>
                                                                                                                <strong>Tipo
                                                                                                                    de
                                                                                                                    PQRS</strong>:{{ $data['tipo_pqrs'] }}
                                                                                                            </div>
                            ...
                            <tr>
                                ...
                                <td align="center" valign="top">
                                    ...
                                    <div style="background-color: rgb(255, 44, 0);">
                                        ...
                                        <table class="rnb-del-min-width rnb-tmpl-width" width="100%"
                                            cellpadding="0" border="0" cellspacing="0" style="min-width:590px;"
                                            name="Layout_7" id="Layout_7">
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" align="center" valign="top"
                                                        style="min-width:590px;">
                                                        ...
                                                        <table width="100%" cellpadding="0" border="0"
                                                            align="center" cellspacing="0" bgcolor="#ff2c00"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td
                                                                        ...
                                                                        <div>
                                                                            <div>&copy; 2024 Muebles Albura SAS</div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>

        ...
        <div class="card-body">
            <div class="d-flex flex-column">
                ...
                <div>
                    <p><b>Buen dia</b></p>
                    @if ($action == 'ingreso')
                        <p>Queremos informarle que la <b>Orden de servicio N° {{ $data->id_st }}</b> llego a fabrica.
                            <br>A continuación, encontrará
                            detalles de las mismas:
                        </p>
                    @else
                        <p>Queremos informarle que la <b>Orden de servicio N° {{ $data->id_st }}</b> salio de fabrica.
                            <br>A continuación, encontrará
                            detalles de las mismas:
                        </p>
                    @endif
                ...
                <br>
                <hr>
                <p><b>Orden de servicio:</b> {{ $data->id_st }}</p>
                <p><b>Cliente:</b> {{ $data->nombre }}</p>
                <p><b>Producto:</b> {{ $data->articulo }}</p>
                <p><b>Dia notificación:</b> {{ date('Y-m-d') }}</p>
                <hr>
                <p><b>Observación:</b> {{ $estado_articulo }}</p>
                <hr>
            </div>
        </div>

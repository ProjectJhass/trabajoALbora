        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a class="btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" href="{{ route('crear.info.nexus') }}"
                        aria-label="Add" data-bs-original-title="Add" aria-describedby="tooltip119922">
                            ...
                            <tbody>
                                @foreach ($usuarios as $item)
                                    <tr>
                                        ...
                                        @php
                                            $color = $item->estado != 'Activo' ? 'bg-danger' : 'bg-success';
                                        @endphp
                                        <td><span class="badge {!! $color !!}">{{ $item->estado }}</span></td>
                                        <td>{{ $item->fecha_ingreso }}</td>
                                        <td>
                                            <div class="flex align-items-center list-user-action">
                                                <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-original-title="Edit" href="#" aria-label="Edit" data-bs-original-title="Edit">
                                                    <span class="btn-inner">
                                                ...
                                                <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" href="#"

        ...
        <tbody>
            <tr>
                <td align="center" valign="top">
                    ...
                    <![endif]-->
                                        <table class="rnb-del-min-width" width="100%" cellpadding="0" border="0" cellspacing="0" style="min-width:100%; -webkit-backface-visibility: hidden; line-height: 10px;"
                                            name="Layout_8" id="Layout_8">
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" valign="top" align="center" style="min-width: 590px;">
                                                        <a href="#" name="Layout_8"></a>
                                                        <table width="100%" class="rnb-container" cellpadding="0" border="0" bgcolor="#ffffff" align="center" cellspacing="0"
                                                                        ...
                                                                        <table cellspacing="0" cellpadding="0" border="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <div
                                                                                            style="border-radius:5px; width:590;;max-width:1023px !important;border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;border-collapse: separate;border-radius: 0px;">
                                                                                            <div><img ng-if="col.img.source != 'url'" border="0" hspace="0" vspace="0" width="590"
                                                                                                    class="rnb-header-img" alt="" style="display:block; float:left; border-radius: 5px; "
                                                                                                    src="https://img.mailinblue.com/2547420/images/rnb/original/6064f93efd8c033c650f289e.jpg"></div>
                                                                                            ...
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="font-family:Arial,Helvetica,sans-serif; color:#3c4858; text-align:center;">
                                                                                                        ...
                                                                                                        <span style="color:#3c4858;"><strong><span style="font-size:24px;">Cotización de venta</span></strong></span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td height="10"></td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858;">
                                                                                                        <div style="line-height: 24px; text-align: justify;"><br>
                                                                                                            Hola 👋 buen día le escribe {{ $asesor }}, su especialista en productos para el hogar 🏡 de Muebles Albura.
                                                                                                            Adjunto envio la cotización de los productos pre-seleccionados por usted. Estaré muy pendiente de la
                                                                                                            confirmación de su compra, y así proceder con la entrega de su pedido lo antes posible.</div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="rnb-del-min-width" align="center" valign="top" style="min-width:590px;">
                                                        ...
                                                        <table width="100%" cellpadding="0" border="0" align="center" cellspacing="0" bgcolor="#ff2c00"
                                                            style="padding-right: 20px; padding-left: 20px; background-color: rgb(255, 0, 0);">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="20" style="font-size:1px; line-height:20px; mso-hide: all;">&nbsp;</td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="font-size:14px; color:#ffffff; font-weight:normal; text-align:center; font-family:Arial,Helvetica,sans-serif;">
                                                                        <div>© {{ date("Y") }} Muebles Albura SAS</div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td height="20" style="font-size:1px; line-height:20px; mso-hide: all;">&nbsp;</td>

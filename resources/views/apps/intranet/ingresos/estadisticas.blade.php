                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-8">
                            <div class="input-group">
                                ...
                                <button class="btn btn-success" type="button" onclick="consultarInfoEstadisticas()">Consultar</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12" id="infoGeneralEstadisticas">
                    {!! $info !!}
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        consultarInfoEstadisticas = () => {
            ...
            if (dateRangePicker.startDate && dateRangePicker.endDate) {
                ...
                datos.done((res) => {
                    if (res.status == true) {
                        document.getElementById('infoGeneralEstadisticas').innerHTML = res.info
                    }
                })
            }
        }

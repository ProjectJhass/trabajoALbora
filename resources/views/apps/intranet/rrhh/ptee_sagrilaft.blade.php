...
@section('head')
    ...
    <link href="{{ asset('plugins/dataTables/tablesB5.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('plugins/dataTables/dataTablesButtons.min.css') }}" rel="stylesheet" />
@endsection
@section('rrhh')
    bg-danger active
@endsection
            ...
            <div class="row mb-4">
                <div class="text-end">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#exampleModal">Modificar flayer</button>
                        <button type="button" class="btn btn-outline-success" onclick="ExportInfoExcel()"><i class="far fa-file-excel"></i>
                            Descargar</button>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="month" value="@php echo date('Y-m') @endphp" onchange="searchInfoDate(this.value)" class="form-control"
                                name="monthSearch" id="monthSearch">
                        </div>
                    </div>
                        ...
                        <div class="card-body" id="imgCreativoPtee">
                            @foreach ($img as $item)
                                <a href="{{ asset($item->url) }}" target="_BLANK">
                                    <img src="{{ asset($item->url) }}" width="100%" alt="">
                                </a>
                            @endforeach
                        </div>
                    </div>
...
@section('footer')
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <form id="form-img-act-flayer" enctype="multipart/form-data" method="post">
                                ...
                                <input type="file" class="form-control" name="imgPrevFlayer" id="imgPrevFlayer" accept="image/*">
                            </form>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-danger" onclick="UpdateFlayer()">Actualizar Flayer</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="{{ asset('plugins/dataTables/jQueryDataTables.min.js') }}"></script>
    <script src="{{ asset('plugins/dataTables/tablesB5.min.js') }}"></script>
    <script src="{{ asset('plugins/dataTables/dataTablesButtons.min.js') }}"></script>
    <script src="{{ asset('plugins/dataTables/buttonsHtml.min.js') }}"></script>

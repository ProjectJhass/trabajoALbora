                ...
                <div class="col-md-10 text-center">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <span class="input-group-append">
                            ...
                            <button type="button" class="btn btn-success btn-flat" onclick="exportFechasDescansos()"><i
...
@section('footer')
    ...
    <script>
        ...
        ConsultarFechasDescansos = () => {
            ...
            var datos = $.ajax({
                url: "{{ route('search.firmas.descansos') }}",
                type: "POST",
                dataType: "json",
                data: {
                    fecha_i,
        ...
        exportFechasDescansos = () => {
            var fecha_i = $('#reservation').data('daterangepicker').startDate.format('YYYY-MM-DD');
            var fecha_f = $('#reservation').data('daterangepicker').endDate.format('YYYY-MM-DD');
            var url_ = "{{ route('export.detalles.firmas', ['fecha_i' => 'FECHAI', 'fecha_f' => 'FECHAF']) }}"
            url_ = url_.replace("FECHAI", fecha_i)
            url_ = url_.replace("FECHAF", fecha_f)

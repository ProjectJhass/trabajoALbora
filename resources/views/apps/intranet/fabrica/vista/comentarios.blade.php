                ...
                <div class="card-header" id="">
                    <div class="d-flex justify-content-end " id="basuras">
                        ...
                        <button type="button" class="btn btn-sm "
                            onclick="borrarComentario('{{ $item['id_comentario']}}','{{ url('/deletecomment') }}')"
                    ...
                    <div class="post">
                        <div class="user-block ">
                            <img class="img-circle img-bordered-sm" id="img-comment" src="{{ asset('storage/img/profile.png') }}"
                                alt="user image">
                            <span class="username ">
                                <small><b>{{ $item['nombre'] }}</b></small>
                            </span>
                            <span class="description "><b>Fecha: </b>{{$item['fecha_comentario']}} <b>Hora: </b>{{$item['hora_comentario']}}</span>

                                            ...
                                            <td class="text-center" id="opcionesCliente{{ $value['id_cliente'] }}">
                                                @if ($value['tipo_cliente'] != '0')
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <a href="{{ url('asesor/maestra/WhatsApp/' . $value['celular_1']) }}" target="_BLANK" type="button" class="btn btn-sm btn-success"
                                                            title="Enviar mensaje al WhatsApp"><i class="fab fa-whatsapp" style="font-size: 15px"></i></a>
                                                    </div>
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" class="form-control" name="co_efect" id="co_efect" placeholder="Ejm. 020" onchange="ValidarInfoClienteEfectivo()" aria-label="Username"
                                        aria-describedby="basic-addon1">
                                </div>
                            </div>
                            <div class="col-md-4">

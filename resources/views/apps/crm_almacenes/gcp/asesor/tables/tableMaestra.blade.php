                ...
                <td class="text-center" id="opcionesCliente{{ $value->id_cliente }}">
                    @if ($value->tipo_cliente != '0')
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <button type="button" class="btn btn-sm btn-primary" title="Programar una llamada"
                                onclick="AgendarLlamadaCliente('{{ $value->id_cliente }}')"><i class="fas fa-phone-alt"
                                    style="font-size: 15px"></i></button>
                            <a href="{{ route('asesor.whatsapp', ['celular' => empty($value->celular_1) ? 1 : $value->celular_1]) }}" target="_BLANK"
                                type="button" class="btn btn-sm btn-success" title="Enviar mensaje al WhatsApp"><i class="fab fa-whatsapp"
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <button type="button" class="btn btn-sm btn-danger" onclick="NotificarEliminacionClienteCrm('{{ $value->id_cliente }}')"
                                title="Eliminar contacto"><i class="fas fa-trash-alt" style="font-size: 15px"></i></button>
                        </div>
                    @endif
                </td>
            </tr>

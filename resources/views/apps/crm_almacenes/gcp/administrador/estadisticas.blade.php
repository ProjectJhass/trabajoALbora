    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body" id="estadisticas-generales-asesores">
                    {!! $estadisticas !!}
                </div>
            </div>
        </div>
...
@section('footer')
    ...
    <script>
        ...
        formatterTables = () => {
            $('#table-clientes-efectivos').DataTable({
                "oLanguage": {
                    "sSearch": "Buscar:",
            ...
            $('#presupuesto-asesor-alm').DataTable({
                "oLanguage": {
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando de _START_ a _END_ de _TOTAL_ registros",
                    "oPaginate": {
            ...
            $('#medios-de-pago-cliente').DataTable({
                "oLanguage": {
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando de _START_ a _END_ de _TOTAL_ registros",
                    "oPaginate": {
            ...
            $('#ciudades-de-compra-cli').DataTable({
                "oLanguage": {
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando de _START_ a _END_ de _TOTAL_ registros",
                    "oPaginate": {
            ...
            $('#productos-vendidos-alb').DataTable({
                "oLanguage": {
                    "sSearch": "Buscar:",
                    "sInfo": "Mostrando de _START_ a _END_ de _TOTAL_ registros",
                    "oPaginate": {
        ...
        ConsultarInfoFechas = () => {
            ...
            var asesor_co = $('#asesor_co').val();

            var datos = $.ajax({
                url: "{{ route('consultar.info.asesor.estadisticas') }}",
                type: "POST",
                dataType: "json",
                data: {
                    fecha_i,
            ...
            datos.done((res) => {
                loadedPanel()
                document.getElementById('estadisticas-generales-asesores').innerHTML = res.estadisticas
                formatterTables()
            });
        }
    </script>
